...
source_file="../../../src/bash/_header/_colors.sh"
...
test_echo_link_should_wrap_text_in_osc8_hyperlink() {
    local output
    output=$(_echo_link "https://example.com" "click here")
    assert_equals $'\033]8;;https://example.com\033\\click here\033]8;;\033\\' "${output}"
}
