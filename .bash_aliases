...
function get_url() {
    function _usage() {
        echo_success 'usage:' "$1" "$2"; echo_primary '_get_url -b (branch) -n (new pull request) -p (pull request) -r (repository) -s (server) -u (username) -h (help)\n'
    }
