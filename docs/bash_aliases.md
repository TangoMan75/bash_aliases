...
anitize string for safe eval (escape backslash, backtick, double quote, dollar)
...
arse branch type, eg: feat/FOO-01/foobar => feat
...
open-commit-in-ide alias

```bash
'open-commit-in-ide'
```

### 🤡 open-conflicts-in-ide
